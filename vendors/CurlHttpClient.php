...
class CurlHttpClient {
    ...
    protected function _setOptions() {
        ...
        //curl_setopt($this->handler,CURLOPT_POSTFIELDS,true);
    }
     ...
     * @param mixed $value
     */
    public function setPostParam($name, $value, $build_query = false) {
        $this->postParams[$name] = $value;
        //curl_setopt($this->handler, CURLOPT_POSTFIELDS, http_build_query($this->postParams));
        if($build_query)
            curl_setopt($this->handler, CURLOPT_POSTFIELDS, http_build_query($this->postParams));
        else
